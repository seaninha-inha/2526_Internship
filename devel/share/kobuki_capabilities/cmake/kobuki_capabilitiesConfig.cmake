...
if("TRUE" STREQUAL "TRUE")
  set(kobuki_capabilities_SOURCE_PREFIX /home/sean/catkin_ws/src/kobuki/kobuki_capabilities)
  set(kobuki_capabilities_DEVEL_PREFIX /home/sean/catkin_ws/devel)
  ...
  set(kobuki_capabilities_INSTALL_PREFIX /home/sean/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://ros.org/wiki/kobuki_capabilities " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/kobuki_capabilities' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'kobuki_capabilities' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'kobuki_capabilities' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sean/catkin_ws/src/kobuki/kobuki_capabilities/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT kobuki_capabilities_NUM_DUMMY_TARGETS)
      set(kobuki_capabilities_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::kobuki_capabilities::wrapped-linker-option${kobuki_capabilities_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR kobuki_capabilities_NUM_DUMMY_TARGETS "${kobuki_capabilities_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::kobuki_capabilities::wrapped-linker-option${kobuki_capabilities_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND kobuki_capabilities_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND kobuki_capabilities_LIBRARIES ${library})
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${kobuki_capabilities_dep}_FOUND)
      find_package(${kobuki_capabilities_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${kobuki_capabilities_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(kobuki_capabilities_EXPORTED_TARGETS ${${kobuki_capabilities_dep}_EXPORTED_TARGETS})
endforeach()
