...
if("TRUE" STREQUAL "TRUE")
  set(kobuki_description_SOURCE_PREFIX /home/sean/catkin_ws/src/kobuki/kobuki_description)
  set(kobuki_description_DEVEL_PREFIX /home/sean/catkin_ws/devel)
  ...
  set(kobuki_description_INSTALL_PREFIX /home/sean/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kobuki_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sean/catkin_ws/src/kobuki/kobuki_description/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT kobuki_description_NUM_DUMMY_TARGETS)
      set(kobuki_description_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::kobuki_description::wrapped-linker-option${kobuki_description_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR kobuki_description_NUM_DUMMY_TARGETS "${kobuki_description_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::kobuki_description::wrapped-linker-option${kobuki_description_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND kobuki_description_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND kobuki_description_LIBRARIES ${library})
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(kobuki_description_EXPORTED_TARGETS ${${kobuki_description_dep}_EXPORTED_TARGETS})
endforeach()
