...
if("TRUE" STREQUAL "TRUE")
  set(kobuki_bumper2pc_SOURCE_PREFIX /home/sean/catkin_ws/src/kobuki/kobuki_bumper2pc)
  set(kobuki_bumper2pc_DEVEL_PREFIX /home/sean/catkin_ws/devel)
  ...
  set(kobuki_bumper2pc_INSTALL_PREFIX /home/sean/catkin_ws/install)
...
if(NOT "/home/sean/catkin_ws/src/kobuki/kobuki_bumper2pc/include " STREQUAL " ")
  set(kobuki_bumper2pc_INCLUDE_DIRS "")
  set(_include_dirs "/home/sean/catkin_ws/src/kobuki/kobuki_bumper2pc/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kobuki_bumper2pc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sean/catkin_ws/src/kobuki/kobuki_bumper2pc/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT kobuki_bumper2pc_NUM_DUMMY_TARGETS)
      set(kobuki_bumper2pc_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::kobuki_bumper2pc::wrapped-linker-option${kobuki_bumper2pc_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR kobuki_bumper2pc_NUM_DUMMY_TARGETS "${kobuki_bumper2pc_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::kobuki_bumper2pc::wrapped-linker-option${kobuki_bumper2pc_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND kobuki_bumper2pc_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND kobuki_bumper2pc_LIBRARIES ${library})
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(kobuki_bumper2pc_EXPORTED_TARGETS ${${kobuki_bumper2pc_dep}_EXPORTED_TARGETS})
endforeach()
