...
C02C2 = np.insert(R_02, 3, T_02, axis=1)
...
ptcloud_C2 = L2C2 @ ptcloud

## 2. 카메라 좌표계에 맞게 뒤를 보는 부분 제거 (Z값 <= 0)
fronts = ptcloud_C2[2, :] > 0 # Z값 > 0
ptcloud_C2 = ptcloud_C2[:, fronts]
